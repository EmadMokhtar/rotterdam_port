...
FLAKE8_ARGS = ["--ignore=E501", "--exclude=rotterdam_port/settings/*"]
APPS = ["cargo"]
EXCLUDE_FILES = ["rotterdam_port/settings/*", "*/migrations/*", "*/tests/*"]
...
def run_django_tests_with_coverage():
    if __name__ == "__main__":
        os.environ['DJANGO_SETTINGS_MODULE'] = 'rotterdam_port.settings'
